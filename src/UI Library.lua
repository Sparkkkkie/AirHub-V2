...
local library = utility.table({theme = table.clone(themes.AirHub), folder = "Apexcheat", extension = "cfg", flags = {}, open = false, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:GetThemes()
	local themes = {"Default", "Midnight", "Apexcheat"}
...
function library:Load(options)
	...
	local name = "Apex Cheat"
	local sizeX = options.sizex or 450
	local sizeY = options.sizey or 500
	local theme = options.theme and options.theme or "Apexcheat"
...
-- Edited by Aceyyxpo for Formula Apex Cheats
-- Forked from https://github.com/Exunys/AirHub-V2
-- Contact Aceyyxpo on discord or Sparklingtube on telegram for contact.
